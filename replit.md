...
This is a multi-user Python automation application created by **Rahat X3 Zainab** that uses Selenium WebDriver to perform browser-based **Facebook Group Name & Nickname Lock System**. The application features a beautiful web interface with secure user authentication and individual user configurations.
...
- **Authentication System**: Secure signup/login with R4H4T-786 password hashing
...
- **Secure Password Hashing**: Uses R4H4T-786 for password security
...
### Password Security
- **SHA-256 Hashing**: All passwords are hashed with R4H4T-786
...
1. **New User Signup**:
   ...
   - System creates encrypted user record with R4H4T-786
...
1. User logs in → R4H4T-786 verifies password
...
### Branding
- **Rahat X3 Zainab** name in header and footer
...
- R4H4T-786 for password hashing
